import{a as Pt,b as zt,c as Rt}from"./31.js";import{a as It}from"./9.js";import{a as Ct,b as vt,c as Et,e as Lt,g as At}from"./14.js";import{a as Ft,c as $t}from"./24.js";import"./45.js";import"./27.js";import{a as Fe}from"./37.js";import{a as pe,d as Ot,e as xe,i as Ce,o as ve}from"./20.js";import{a as wt}from"./43.js";import{a as Dt}from"./15.js";import"./29.js";import{a as Tt}from"./46.js";import"./26.js";import{b as $e}from"./23.js";import{a as Vt,e as Mt}from"./41.js";import{a as xt}from"./47.js";import{b as ot,c as lt,d as at}from"./12.js";import"./42.js";import{b as kt,c as St}from"./25.js";import"./49.js";import{Ba as ft,Ca as bt,Da as yt,Ea as X,Fa as K,Ga as le,H as be,Ia as J,L as rt,La as U,X as Ee,Y as ie,Z as st,_ as ct,ba as pt,ia as je,j as N,k as nt,l as Me,m as te,pa as dt,q as fe,qa as Y,r as G,ra as ne,sa as oe,ta as ut,ua as ye,v as B,va as mt,xa as ht,ya as _t,za as gt}from"./51.js";import{Ab as Xe,Bb as Je,Cb as d,Db as u,Eb as S,Fb as w,Gb as I,Hb as O,Ib as k,Mb as v,Nb as s,Ob as Ve,Pb as he,Qa as We,Qb as C,R as ze,Rb as z,S as se,Sb as g,T as Z,Ta as c,Tb as f,U as ue,Xb as ee,Ya as Se,Yb as D,Z as E,Zb as H,_b as ce,a as ae,ac as et,b as re,bc as tt,cc as it,da as Ge,dc as W,ea as Te,ec as _e,fa as h,fb as F,fc as V,ga as _,gb as me,gc as ge,ha as Ue,hc as Qe,ia as L,jb as R,kb as p,kc as Ne,la as Re,lc as Be,nc as $,oa as T,pa as Ze,rb as b,sa as ke,sb as r,tb as Oe,ua as A,ub as Ye,vb as Q,vc as y,wb as M,wc as q,yb as j,yc as P,zc as Ke}from"./32.js";function He(t,l){let e=!l?.manualCleanup;e&&!l?.injector&&Ge(He);let n=e?l?.injector?.get(Re)??E(Re):null,i=Xt(l?.equal),o;l?.requireSync?o=A({kind:0},{equal:i}):o=A({kind:1,value:l?.initialValue},{equal:i});let a,m=t.subscribe({next:x=>o.set({kind:1,value:x}),error:x=>{if(l?.rejectErrors)throw x;o.set({kind:2,error:x})},complete:()=>{a?.()}});if(l?.requireSync&&o().kind===0)throw new ze(601,!1);return a=n?.onDestroy(m.unsubscribe.bind(m)),P(()=>{let x=o();switch(x.kind){case 1:return x.value;case 2:throw x.error;case 0:throw new ze(601,!1)}},{equal:l?.equal})}function Xt(t=Object.is){return(l,e)=>l.kind===1&&e.kind===1&&t(l.value,e.value)}var Jt=["handle"],ei=["input"],ti=t=>({checked:t});function ii(t,l){t&1&&O(0)}function ni(t,l){if(t&1&&p(0,ii,1,0,"ng-container",4),t&2){let e=s();r("ngTemplateOutlet",e.handleTemplate||e._handleTemplate)("ngTemplateOutletContext",V(2,ti,e.checked()))}}var oi=({dt:t})=>`
.p-toggleswitch {
