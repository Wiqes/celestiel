import{a as Dt,b as Pt,c as zt}from"./24.js";import{a as At}from"./31.js";import"./9.js";import{a as xt,b as Ct,c as Mt,e as Et,g as $t}from"./18.js";import{a as Vt,c as Ft}from"./37.js";import"./22.js";import"./25.js";import{a as Oe}from"./16.js";import{a as se,d as kt,e as ge,i as fe,o as be}from"./28.js";import{a as vt}from"./44.js";import{a as Lt}from"./26.js";import"./29.js";import{a as wt}from"./39.js";import"./27.js";import{b as Me}from"./14.js";import{a as Tt,e as Ot}from"./52.js";import{a as yt}from"./41.js";import{b as nt,c as ot,d as lt}from"./19.js";import"./43.js";import{b as It,c as St}from"./40.js";import"./49.js";import{Aa as gt,Ba as ft,Ca as bt,Da as le,Ea as q,Fa as _e,G as me,Ha as ae,K as at,Ka as X,W as Te,X as Z,Y as st,Z as rt,aa as ct,ha as Qe,j as K,k as it,l as ke,m as de,oa as pt,pa as G,q as ue,qa as W,r as U,ra as Y,sa as dt,ta as he,u as H,ua as ut,wa as mt,xa as ht,ya as _t}from"./42.js";import{$b as ne,Ab as We,Ac as Re,Bb as Ye,Cb as d,Db as m,Eb as k,Fb as w,Gb as I,Hb as T,Ib as M,Mb as v,Nb as r,Ob as Xe,Pb as Ae,R as $e,Rb as C,S as te,Sb as L,T as ie,Ta as c,Tb as h,U as ve,Ub as _,Ya as Ie,Yb as re,Z as E,Zb as D,_b as j,a as J,b as ee,bc as Je,cc as et,da as He,dc as tt,ea as qe,ec as oe,fa as f,fb as $,fc as ce,ga as b,gb as Se,gc as O,ha as je,hc as pe,ia as P,ic as De,jb as Q,kb as p,la as Le,lc as Pe,mc as ze,oa as S,oc as A,pa as Ge,rb as x,sa as we,sb as s,tb as Ue,ua as V,ub as Ze,vb as N,wb as z,wc as y,xc as B,yb as R,zc as F}from"./35.js";function Ne(t,l){let e=!l?.manualCleanup;e&&!l?.injector&&He(Ne);let n=e?l?.injector?.get(Le)??E(Le):null,i=Zt(l?.equal),o;l?.requireSync?o=V({kind:0},{equal:i}):o=V({kind:1,value:l?.initialValue},{equal:i});let a,u=t.subscribe({next:g=>o.set({kind:1,value:g}),error:g=>{if(l?.rejectErrors)throw g;o.set({kind:2,error:g})},complete:()=>{a?.()}});if(l?.requireSync&&o().kind===0)throw new $e(601,!1);return a=n?.onDestroy(u.unsubscribe.bind(u)),F(()=>{let g=o();switch(g.kind){case 1:return g.value;case 2:throw g.error;case 0:throw new $e(601,!1)}},{equal:l?.equal})}function Zt(t=Object.is){return(l,e)=>l.kind===1&&e.kind===1&&t(l.value,e.value)}var Wt=["handle"],Yt=["input"],Xt=t=>({checked:t});function Jt(t,l){t&1&&T(0)}function ei(t,l){if(t&1&&p(0,Jt,1,0,"ng-container",4),t&2){let e=r();s("ngTemplateOutlet",e.handleTemplate||e._handleTemplate)("ngTemplateOutletContext",O(2,Xt,e.checked()))}}var ti=({dt:t})=>`
.p-toggleswitch {
