...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function ov(s,e,t){let i=new Float32Array(Vs),n=new D(0,1,0);return new Ei({name:"SphericalGaussianBlur",defines:{n:Vs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:n}},vertexShader:zc(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function Tp(){return new Ei({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zc(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function Ep(){return new Ei({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zc(),fragmentShader:`
